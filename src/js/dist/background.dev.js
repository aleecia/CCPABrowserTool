...
function storeFirstPartyRequest(r3, r2, r1) {
  return new Promise(function (resolve, reject) {
    chrome.tabs.getSelected(null, function (tab) {
      ...
      chrome.storage.local.get('firstPartyRequests', function (data) {
        if (chrome.runtime.lastError) {
          ...
          if (firstPartyRequests) {
            firstPartyRequests = firstPartyRequests.filter(function (p) {
  ...
  return new Promise(function (resolve, reject) {
    chrome.tabs.getSelected(null, function (tab) {
      ...
      if (chrome.runtime.lastError) {
        ...
        chrome.storage.local.get('thirdPartyRequests', function (data) {
          if (chrome.runtime.lastError) {
            return;
          }
          ...
          if (thirdPartyRequests) {
            thirdPartyRequests = thirdPartyRequests.filter(function (p) {
              return p.domain !== tablink;
            });
          ...
          chrome.storage.local.set({
            ...
            return chrome.runtime.lastError ? reject(Error(chrome.runtime.lastError.message)) : resolve(thirdPartyRequests);
          });
        });
      }
    });
...
function getDefaultPreference() {
  return new Promise(function (resolve, reject) {
    return chrome.storage.local.get('defaultPreference', function (result) {
...
function isInExceptionListHelper(tablink) {
  return new Promise(function (resolve) {
    var inExceptionList;
    chrome.storage.local.get('customPreferences', function (data) {
...
function modifyRequestHeaderHandler(details) {
  ...
  isThirdPartyURL(details.url).then(sendRequest).then(function (ccpa) {
    ccpa1 = ccpa;
  });
